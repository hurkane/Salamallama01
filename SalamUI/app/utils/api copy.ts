...
//export const API_BASE_URL = "http://20.36.29.158";
export const API_BASE_URL = "https://salamallama.com";

export const register = async (name, username, email, password) => {
  const response = await axios.post(`${API_BASE_URL}:5000/api/auth/register`, {
    name,
    username,
    email,
    password,
...
export const requestPasswordReset = async (email) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}:5000/api/auth/requestPasswordReset`,
      { email }
    );
    return response.data;
  } catch (error) {
...
export const resetPassword = async (token, id, newPassword) => {
  const response = await axios.post(
    `${API_BASE_URL}:5000/api/auth/resetPassword`,
    {
      token,
      id,
      newPassword,
...
export const login = async (email: string, password: string) => {
  const response = await axios.post(`${API_BASE_URL}:5000/api/auth/login`, {
    email,
    password,
  });
  return {
...
export const getPost = async (postId, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5002/api/posts/${postId}`,
...
export async function getComment(commentId, token) {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5004/comments/${commentId}`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
    ...
    if (comment?.userId) {
      const userResponse = await axios.get(
        `${API_BASE_URL}:5001/api/user/${comment.userId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
...
export async function getSubComments(parentId, token) {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5004/comments/${parentId}/subcomments`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
    ...
    for (const subComment of subComments) {
      if (subComment.media) {
        const mediaUrl = `${API_BASE_URL}:5003/media/${subComment.media}`;
...
export const getProfilePicture = async (userId: string, token: string) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5001/api/user/${userId}/profilePicture`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const getUserInfo = async (userId: string, token: string) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5001/api/user/${userId}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const getPopularUsers = async (token: string) => {
  const response = await axios.get(`${API_BASE_URL}:5001/api/user/popular`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export const updateUserInfo = async (data: any, token: string) => {
  const response = await axios.put(`${API_BASE_URL}:5001/api/user`, data, {
    headers: { Authorization: `Bearer ${token}` },
  });
  return response.data;
};
...
export const updateProfilePicture = async (
  ...
  const response = await axios.put(
    `${API_BASE_URL}:5001/api/user/profilePicture`,
    formData,
    { headers: { Authorization: `Bearer ${token}` } }
  );
  return response.data;
...
export const getBanner = async (userId, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5001/api/user/${userId}/banner`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const updateBanner = async (formData, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}:5001/api/user/Banner`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const getInteractions = async (postId, token) => {
  try {
    ...
    const response = await axios.get(
      `${API_BASE_URL}:5005/interactions/post/${postId}`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const getCurrentUserInteraction = async (postId, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5005/interactions/post/${postId}/current`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const getCommentInteractions = async (commentId, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5005/interactions/comment/${commentId}`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const getCurrentUsercommentInteraction = async (commentId, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5005/interactions/comment/${commentId}/current`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const removeInteraction = async (interactionId, token) => {
  await axios.delete(
    `${API_BASE_URL}:5005/interactions/remove/${interactionId}`,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
  );
...
export const likePost = async (postId: string, token: string) => {
  try {
    ...
    const response = await axios.post(
      `${API_BASE_URL}:5005/interactions/like/post/${postId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const dislikePost = async (postId: string, token: string) => {
  try {
    ...
    const response = await axios.post(
      `${API_BASE_URL}:5005/interactions/dislike/post/${postId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const sendViewInteraction = async (postId: string, token: string) => {
  try {
    ...
    const response = await axios.post(
      `${API_BASE_URL}:5005/interactions/view/post/${postId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
...
export const getCommentsForPost = async (
  ...
  const response = await axios.get(
    `${API_BASE_URL}:5004/posts/${postId}/comments?page=${page}`,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
  );
...
export const addComment = async (
  ...
  const response = await axios.post(`${API_BASE_URL}:5004/comments`, formData, {
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "multipart/form-data",
    },
...
export const likeComment = async (commentId: string, token: string) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}:5005/interactions/like/comment/${commentId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
    return response.data;
...
export const dislikeComment = async (commentId: string, token: string) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}:5005/interactions/dislike/comment/${commentId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
    return response.data;
...
export const viewComment = async (commentId: string, token: string) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}:5005/interactions/view/comment/${commentId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
    return response.data;
...
export const getFeed = async (page, token) => {
  const response = await axios.get(
    `${API_BASE_URL}:5007/api/feed/all?page=${page}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getFollowingFeed = async (page, token) => {
  const response = await axios.get(`${API_BASE_URL}:5007/api/feed/following`, {
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
    },
...
export const getPopularFeed = async (page, token) => {
  const response = await axios.get(`${API_BASE_URL}:5007/api/feed/popularity`, {
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
    },
...
export const getUserPosts = async (userId, page, token) => {
  const response = await axios.get(
    `${API_BASE_URL}:5002/api/user/${userId}/posts?page=${page}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const unfollowUser = async (followedId: string, token: string) => {
  const response = await axios.delete(
    `${API_BASE_URL}:5001/api/follow/unfollow`,
    {
      data: { followedId },
      headers: { Authorization: `Bearer ${token}` },
    }
...
export const getFollowStatus = async (
  ...
  const url = `${API_BASE_URL}:5001/api/follow/status?followerId=${followerId}&followedId=${followedId}`;
...
export const getFollowers = async (userId: string, token: string) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5001/api/user/${userId}/followers`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const getFollowing = async (userId: string, token: string) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5001/api/user/${userId}/following`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const removeFollower = async (followId: string, token: string) => {
  const response = await axios.delete(
    `${API_BASE_URL}:5001/api/follow/remove/${followId}`,
    { headers: { Authorization: `Bearer ${token}` } }
  );
  return response.data;
};
...
export const getNotifications = async (
  ...
  const response = await fetch(
    `${API_BASE_URL}:5006/notifications/user/${userId}?limit=${limit}&offset=${offset}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const getUnseenNotifications = async (userId, token, limit, offset) => {
  const response = await axios.get(
    `${API_BASE_URL}:5006/notifications/unseen/${userId}?limit=${limit}&offset=${offset}`,
    { headers: { Authorization: `Bearer ${token}` } }
  );
  return response.data;
};
...
export const markNotificationAsSeen = async (notificationId, token) => {
  const response = await axios.put(
    `${API_BASE_URL}:5006/notifications/${notificationId}/seen`,
    {},
    { headers: { Authorization: `Bearer ${token}` } }
  );
  return response.data;
...
export const getFollowRequests = async (token) => {
  const response = await axios.get(`${API_BASE_URL}:5001/api/follow/requests`, {
    headers: { Authorization: `Bearer ${token}` },
  });
  return response.data;
};
...
export const acceptFollowRequest = async (id, token) => {
  const response = await axios.put(
    `${API_BASE_URL}:5001/api/follow/accept/${id}`,
    {},
    {
      headers: { Authorization: `Bearer ${token}` },
    }
...
export const rejectFollowRequest = async (id, token) => {
  const response = await axios.put(
    `${API_BASE_URL}:5001/api/follow/reject/${id}`,
    {},
    {
      headers: { Authorization: `Bearer ${token}` },
    }
...
export const getTopSentences = async (page, limit, token) => {
  const response = await axios.get(
    `${API_BASE_URL}:5002/api/post/top-sentences`,
    {
      headers: { Authorization: `Bearer ${token}` },
      params: { page, limit },
    }
...
export const searchPostsByKeyword = async (keyword, page, limit, token) => {
  const response = await axios.get(`${API_BASE_URL}:5002/api/post/search`, {
    headers: { Authorization: `Bearer ${token}` },
...
export const searchUsersByKeyword = async (keyword, page, limit, token) => {
  try {
    const response = await axios.get(`${API_BASE_URL}:5001/api/user/search`, {
      headers: { Authorization: `Bearer ${token}` },
      params: { keyword, page, limit },
    });
...
export const getChats = async (userId, token, page = 1, limit = 10) => {
  ...
  try {
    const response = await axios.get(`${API_BASE_URL}:5008/api/chat`, {
      headers: { Authorization: `Bearer ${token}` },
...
export const getChatById = async (chatId, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}:5008/api/chat/${chatId}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const createGroupChat = async ({ name, users, token }) => {
  ...
  try {
    const response = await axios.post(
      `${API_BASE_URL}:5008/api/chat/group`,
...
export const renameGroupChat = async (chatId, newName, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}:5008/api/chat/rename`,
...
export const addToGroupChat = async (chatId, userId, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}:5008/api/chat/groupadd`,
      { chatId, userId },
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const removeFromGroupChat = async (chatId, userId, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}:5008/api/chat/groupremove`,
      { chatId, userId },
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const addAdminToGroupChat = async (chatId, userId, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}:5008/api/chat/addadmin`,
      { chatId, userId },
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchMetadata = async (url) => {
  try {
    ...
    const response = await axios.get(
      `${API_BASE_URL}:5003/api/preview?url=${encodeURIComponent(url)}`
    );
